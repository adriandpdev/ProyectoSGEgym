...
public class listado extends JInternalFrame {
	...
	private JPanel panel_norte, panel_sur, panel_central, panel_norte_busqueda, panel_central_listado, panel_este,
			panel_oeste, panel_flow;
	...
	private void construirTabla() {
		...
		// se asignan los títulos de las columnas para enviarlas al constructor de la
		// tabla
	...
	private Object[][] arrayDatos(ArrayList<String> titulosList) {
		...
		// Creamos un array bidimensional donde las filas que corresponden a los
		// usuarios son dinámicas y las columnas que pertenecen a los campos son
		// estáticas
	...
	private void crearTabla(String[] titulos, Object[][] data) {
		...
		tablaPersonas.getColumnModel().getColumn(Indicadores.DNI).setPreferredWidth(20);// dni
		tablaPersonas.getColumnModel().getColumn(Indicadores.NOMBRE);// nombre
		tablaPersonas.getColumnModel().getColumn(Indicadores.APELLIDO);// apellido
		tablaPersonas.getColumnModel().getColumn(Indicadores.CUENTABANC);// cuenta bancaria
		tablaPersonas.getColumnModel().getColumn(Indicadores.PASS);// password
		tablaPersonas.getColumnModel().getColumn(Indicadores.FECHANAC);// fecha de nacimiento
		tablaPersonas.getColumnModel().getColumn(Indicadores.TELEFONO);// telefono
		tablaPersonas.getColumnModel().getColumn(Indicadores.CORREO);// correo electrónico
		tablaPersonas.getColumnModel().getColumn(Indicadores.ROL).setPreferredWidth(20);// rol
