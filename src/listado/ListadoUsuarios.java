...
public class ListadoUsuarios extends JInternalFrame implements MouseListener,KeyListener, ActionListener{
...
//		UIManager.put("OptionPane.messageForeground",new ColorUIResource(Color.WHITE));
	...
	public ArrayList<Persona> datarPersonas(){
		...
		String sql = "SELECT * FROM Persona WHERE rol = 'user'";
	...
	public ArrayList<Persona> datarPersonasBusqueda(){
		...
		if(criterio == 0) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND DNI like '" + parametro + "%'";
		} else if(criterio == 1) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND nombre like '" + parametro + "%'";
		} else if(criterio == 2) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND apellido like '" + parametro + "%'";
		} else if(criterio == 3) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND cuentabanc like '" + parametro + "%'";
		} else if(criterio == 4) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND fechanac like '" + parametro + "%'";
		} else if(criterio == 5) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND telefono like '" + parametro + "%'";
		} else if(criterio == 6) {
			sql_busqueda = "SELECT * FROM Persona WHERE rol = 'user' AND correo like '"+ parametro + "%'";
		}
