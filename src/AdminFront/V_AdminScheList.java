...
public class V_AdminScheList extends JInternalFrame{
	...
	String [] horas = {"8:00","9:00","10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00","18:00","19:00","20:00","21:00","22:00"};
	...
	public V_AdminScheList() throws SQLException {
		...
		for (int i = 0; i < horas.length; i++) {
			for (int j = 0; j < diasemana.length; j++) {
					...
					{	
					String query="select a.nombre  as nombre from"
							+ " Horario h, Actividad a"
								+ " where h.IdActividad=a.idActividad"
									+ " and h.hora like '"+ horas[i] +":00' "
