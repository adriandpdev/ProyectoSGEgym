...
public class V_AdminEstActi extends JInternalFrame {
	...
	public void rellenar() throws SQLException {
		String sql = "select Actividad.nombre,Reserva.idHora, COUNT(*) FROM Actividad , Reserva,Horario WHERE Actividad.idActividad=Horario.IdActividad "
				+"AND Horario.IdHora=Reserva.idHora GROUP BY idHora ORDER BY `COUNT(*)` DESC";
